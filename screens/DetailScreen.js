...
const DetailScreen = ({ route }) => {
    const { imgSrc, title, location, price, status, rating, priceLevel, bearing, description, cuisine, phone, email, address } = route.params;
    useLayoutEffect(() => {
            ...
            <ScrollView className="flex-1 px-4 py-6 ">
                ...
                <View className="mt-4 flex-row items-center justify-between">
                    ...
                    <View className=" flex-row items-center space-x-2">
                        ...
                        <View>
                            <Text className="text-[#515151]">{priceLevel}</Text>
